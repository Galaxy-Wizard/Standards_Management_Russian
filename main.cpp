			...
			if (BitMapHandle != NULL)
			{
				...
				if (MemoryLeaksDebugingDone)
				{
					...
					if (MemoryLeaksDebugingDone)
					{
						...
						//	Year
						{
							if (Rectangle(DeviceContextHandle, 250 + 40 * 7, 16 + 30 + 30 + 30 + 50 + 100 + 10 + 40 * 6 + 20 + 64 + 20, 250 + 40 * 7 + 40, 16 + 30 + 30 + 30 + 50 + 100 + 10 + 40 * 6 + 20 + 64 + 20 + 30) != TRUE)
							{
								std::wstring Error(ErrorDrawingString);

								Result = 1;
							}
							if (Rectangle(DeviceContextHandle, 250 + 40 * 7, 16 + 30 + 30 + 30 + 50 + 100 + 10 + 40 * 6 + 20 + 64 + 20 + 30 + 5, 250 + 40 * 7 + 40, 16 + 30 + 30 + 30 + 50 + 100 + 10 + 40 * 6 + 20 + 64 + 20 + 30 + 5 + 30) != TRUE)
							{
								std::wstring Error(ErrorDrawingString);
							...
							CurrentUp += WCHAR(UpArrow);
							Integer CurrentUpLength = Integer(CurrentUp.length());
							if (TextOutW(DeviceContextHandle, 250 + 40 * 7 + 10, 16 + 30 + 30 + 30 + 50 + 100 + 10 + 40 * 6 + 20 + 64 + 20 + 5, CurrentUp.c_str(), CurrentUpLength) != TRUE)
							{
								std::wstring Error(ErrorDrawingString);
							...
							CurrentDown += WCHAR(DownArrow);
							Integer CurrentDownLength = Integer(CurrentDown.length());
							if (TextOutW(DeviceContextHandle, 250 + 40 * 7 + 10, 16 + 30 + 30 + 30 + 50 + 100 + 10 + 40 * 6 + 20 + 64 + 20 + 30 + 5 + 5, CurrentDown.c_str(), CurrentDownLength) != TRUE)
							{
								std::wstring Error(ErrorDrawingString);
